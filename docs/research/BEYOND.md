...
- **Evidence (TODO):** GitHub fine-grained PATs grammar; Vault policy ACLs; AWS IAM resource ARNs.
...
- **Evidence (TODO):** Vault transit per-version keys; AWS KMS GenerateDataKey-without-plaintext patterns.
...
- **Evidence (TODO):** NIST FIPS-204 (Aug 2024 final); Cloudflare and AWS KMS hybrid rollouts (2025).
...
- **Evidence (TODO):** biscuit-auth spec; Tailscale node-key delegation; Macaroon paper (Birgisson et al. 2014).
...
- **Evidence (TODO):** SPIFFE/SPIRE spec; HashiCorp Vault SPIFFE auth method.
...
- **Evidence (TODO):** Certificate Transparency RFC 6962; Trillian; sigstore Rekor.
...
- **Evidence (TODO):** OPA / Rego; AWS Cedar; Vault Sentinel as proprietary analog.
